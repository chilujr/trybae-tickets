...
$model = new model();
$id = $_SESSION['id'];
$events = $model->getAllEvents($id);

if(isset($_GET['u_id']))
{
    $id = $_GET['u_id'];
    $publish = 0;
    $story = changeState($id, $publish);
    $info = "Successfully Unpublished Your Story";
...
if(isset($_GET['p_id']))
{
    ...
    $publish = 1;
    $story = changeState($id, $publish);
    $info = "Successfully published Your Story";
}
 ?>
                    ...
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          ...
                          <p class="mb-4">
                            Here are all the <span class="fw-bold">Events</span> published on The Trybae Site. as Event Organizer You can manage all your Events and Account.
                          </p>

                          <a href="ticket_purchase.php" class="btn btn-sm btn-outline-primary">View Transactions </a>
                        </div>
                      </div>
                              ...
                              <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                  ...
                                  ><?php if ($row['published']): ?>
                                    <a class="dropdown-item" href="view-posts.php?u_id=<?=$row['id']?>"
                                    ><i class="bx bx-file me-2"></i>Unpublish</a
                                  ><?php else: ?>
                                    <a class="dropdown-item" href="view-posts.php?p_id=<?=$row['id']?>"
