        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Action /</span>Manage Attendance</h4>

              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item">
                      <a class="nav-link" href="add-events.php"><i class="bx bx-plus me-1"></i>Scan QR-Code</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link active" href="view-events.php"
                        ><i class="bx bx-bell me-1"></i>View Attendance</a
                      >
                    </li>
                  </ul>
