                  ...
                  <div class="card mb-4">
                    ...
                    <?php while($profile = $myprofile->fetch(PDO::FETCH_ASSOC)):{
                      if(empty($profile['images'])):
                        ...
                        $src = "../../admin/uploads/profile/event_org/".$profile['images'];
                      endif;
                    }
                      ...
                      <form id="formAccountSettings"  method="POST" onsubmit="false" enctype="multipart/form-data">
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <?php if($profile['role'] == 'eventOrg'):
                              $admin = "<input class='form-control' type='text' name='role' id='role' value='eventOrg' disabled/>"; 
                              else:
