              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="card mb-4">
                    ...
                    <hr class="my-0" />
                    <div class="card-body">
                    <form method="POST" onsubmit="false" enctype="multipart/form-data">
                        <?php 
                        ...
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <select class="select2 form-select" name="role" id="roles" required>
                          ...
                          <div class="mb-3 col-md-6">
                            <label class="form-label" for="status">Activation Status</label>
                            <select class="select2 form-select" name="status" id="status" required>
                              <option value="">Select Active Status</option>
                                  <option value="verified">Active</option>
                                  <option value="notverified">De-Activate</option>
                            </select>
                          </div>
                        <div class="row">
                            <div class="mt-2">
                            <button type="submit" name="add-user" class="btn btn-primary me-2">Save changes</button>
